...
public class ExportManager{
    ...
    private void readDataFromDB(){
        ...
        List<Try> tries = db.getTries(currentRewardGroup);
    ...
    private void createLabel(WritableSheet sheet) throws WriteException {
        ...
        addCaption(sheet, rewards.size()+2, 0, "Anzahl Siege");
        addCaption(sheet, rewards.size()+3, 0, "Anzahl Versuche");
        addCaption(sheet, rewards.size()+3, 0, "Anzahl Steps");
        addCaption(sheet, rewards.size()+3, 0, "Rewards Differenz");
